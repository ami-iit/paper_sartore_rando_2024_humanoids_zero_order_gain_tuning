...
class CentroidalMPC(Planner): 
    ...
    def __init__(self, robot_model, frequency_ms = 60, frequency_foot_position_seconds=0.1):

        self.dT = timedelta(milliseconds=frequency_ms)
        self.dT_in_seconds = frequency_ms/1000
        self.contact_planner = FootPositionPlanner(robot_model=robot_model, dT=timedelta(seconds=frequency_foot_position_seconds))
    ...
    def define_test_com_traj(self, com0): 
        ...
        time_knots=[]
        #  -0.00279209 0.631469
        # -0.02445153  0.01006531  0.73182115
        # -0.06522661 -0.00337536  0.63165617
        # com0 = [-0.06522661, 0.0,  0.63165617]
